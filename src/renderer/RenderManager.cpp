...
void RenderManager::RenderBaseShader() {
    ...
    GLint ambientStrengthLoc = glGetUniformLocation(ShaderManager::getInstance()->baseShader->shaderProgramID, "ambientStrength");
    glUniform1f(ambientStrengthLoc, 1.0f);

    GLint ambientColorLoc = glGetUniformLocation(ShaderManager::getInstance()->baseShader->shaderProgramID, "ambientColor");
