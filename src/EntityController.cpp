...
// TODO: Collision setup should be handled by a physics class, pass Entity pointer there
...
void EntityController::CheckPosition() {
    ...
    CameraManager::getInstance()->mainCamera->cameraPos = glm::vec3(sourceCoord.x, sourceCoord.y + 10.0f,
                                                                    sourceCoord.z + 5.0f);
